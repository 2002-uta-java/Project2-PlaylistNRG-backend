...
public class GroupServiceTest {
	private static final String TESTGRP =  "testGroup";
	@InjectMocks
	...
	public void testCreation() {
		Group group = new Group(TESTGRP, "test", 1);
	...
	public void getGroupByValidId() {
		when(gd.getGroupById(1)).thenReturn(new Group(1,TESTGRP, "test", 1));
		Group expected = new Group(1, TESTGRP, "test", 1);
